...
import 'package:campus_buddy/features/events/screens/event_details_screen.dart';
...
class _EventCreateScreenState extends State<EventCreateScreen> {
  ...
  void _createEventUIOnly() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text("Create Event clicked (UI only)."),
      ),
    );

    //  Go to Event Details screen (UI only)
    Navigator.push(
      context,
      MaterialPageRoute(
